  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row justify-center items-center bg-gradient-to-br from-purple-900 to-indigo-800 text-white px-4 overflow-hidden">
      <motion.div
        ...
        <motion.div className="flex flex-col md:items-center md:flex-row  gap-3">
          <motion.button
            onClick={handleAlert}
            whileHover={{ scale: 1.1, backgroundColor: "#5c6bc0" }}
            whileTap={{ scale: 0.95 }}
            className="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 rounded-xl shadow-lg text-lg transition duration-300 ease-in-out transform">
            Say Hello
          </motion.button>

          <motion.button>
          <motion.a
            href="/src/assets/my cv.txt"
            download
